...
namespace GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Tests\Session;

use PHPUnit\Framework\TestCase;
use GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag;
use GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\Flash\FlashBag;
use GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\Session;
use GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
use GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
{
    /**
     * @var \GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('GravityKit\\BlockMCP\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\BlockMCP\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
