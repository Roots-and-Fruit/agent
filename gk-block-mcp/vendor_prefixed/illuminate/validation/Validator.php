...
namespace GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation;
...
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\Fluent;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\MessageBag;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Container\Container;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator;
use GravityKit\BlockMCP\Symfony\Component\HttpFoundation\File\UploadedFile;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Validation\Validator as ValidatorContract;
class Validator implements ValidatorContract
{
    use \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\Concerns\FormatsMessages, \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\Concerns\ValidatesAttributes;
    /**
     * The Translator implementation.
     *
     * @var \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
    protected $translator;
    /**
     * The container instance.
     *
     * @var \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Container\Container
     */
    protected $container;
    /**
     * The Presence Verifier implementation.
     *
     * @var \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    protected $messages;
    /**
     ...
     * @var array
     */
    protected $dependentRules = ['RequiredWith', 'RequiredWithAll', 'RequiredWithout', 'RequiredWithoutAll', 'RequiredIf', 'RequiredUnless', 'Confirmed', 'Same', 'Different', 'Unique', 'Before', 'After', 'BeforeOrEqual', 'AfterOrEqual'];
    /**
     ...
     *
     * @param  \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return void
     *
     * @throws \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\ValidationException
     */
    ...
    {
        return gravitykit_blockmcp_collect($this->messages()->toArray())->map(function ($message, $key) {
     ...
     *
     * @return \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     *
    ...
    {
        return gravitykit_blockmcp_tap($this->getPresenceVerifier(), function ($verifier) use ($connection) {
     ...
     *
     * @param  \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @param  \GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Container\Container  $container
     * @return void
     */
