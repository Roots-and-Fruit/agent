...
namespace GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\Concerns;
...
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\Rules\Exists;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\Rules\Unique;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Validation\ValidationData;
use GravityKit\BlockMCP\Symfony\Component\HttpFoundation\File\File;
...
trait ValidatesAttributes
{
    ...
    {
        if (in_array($attribute, gravitykit_blockmcp_array_collapse($this->implicitAttributes))
                && ! is_numeric($last = gravitykit_blockmcp_last(explode('.', $attribute)))) {
            return $last;
        }
