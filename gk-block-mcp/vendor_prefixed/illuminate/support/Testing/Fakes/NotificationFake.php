...
namespace GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\Testing\Fakes;

use Ramsey\Uuid\Uuid;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Support\Collection;
use PHPUnit\Framework\Assert as PHPUnit;
use GravityKit\BlockMCP\Foundation\ThirdParty\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
...
class NotificationFake implements NotificationFactory
{
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        if (! $this->hasSent($notifiable, $notification)) {
            return gravitykit_blockmcp_collect();
        }
        ...
        $notifications = gravitykit_blockmcp_collect($this->notificationsFor($notifiable, $notification));
